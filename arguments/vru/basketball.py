...
# All experiment switches live here (no shell env vars required).
# Per-segment scripts only pass -s / -m / --frames_start_end / --base_path when needed.

ModelParams = dict(
    # Initial point cloud; override with --base_path for segment-specific PLYs
...
OptimizationParams = dict(
    ...
    # Static voxel features (False => dense voxel grid)
    use_hashgrid=False,
    open_feat_cat=True,

    # Dynamic STF + rendering helpers
