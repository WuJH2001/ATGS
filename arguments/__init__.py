...
class ModelParams(ParamGroup): 
    def __init__(self, parser, sentinel=False):
        ...
        # ATGS: point cloud & temporal masking (override in configs/*.py)
        self.base_path = ""
...
class OptimizationParams(ParamGroup):
    def __init__(self, parser):
        ...
        self.zerostamp_init = True
        self.custom_sampler = None
        self.hash = True
        self.batch_size = 1

        # ATGS representation / training switches (override in configs/*.py)
        self.level_0_dim = 32
        self.use_hashgrid = False
        self.open_feat_cat = True
        self.open_clear_storage_hash = True
        self.open_split_dy_lr = False
        self.open_anchor_feat_delay = True
        self.enable_lifetime_decay = False
        self.lifetime_min_decay = 0.5
        self.mlp_chunk_size = 0
        self.max_lr_iteration = 200_000
        self.hash_batch_size = 1024 * 256
        self.auto_encoder_levels = False
        self.encoder_balanced_accumulation = False
        self.gradient_accumulation_steps = 1
        self.gradient_clip_norm = 0.0
        self.lr_warmup_updates = 0
        self.lr_warmup_start_factor = 0.1

        # Render / training helpers (formerly env vars)
        self.primitive_type = "3dgs"
        self.near_plane = 0.01
        self.absgrad = False
        self.dy_lr_scale = 1.0
        self.clip_size = 20
        self.render_feature = "all"
        self.render_kind = "smooth"
        self.virtual_frame_interval = 40
        self.save_optimizer = True
        self.skip_blender = True
        self.blender_path = ""
        self.open_single_view = False
        self.single_view_idx = 0
        self.blender_offset = 0
        self.blender_name = "main"
        self.open_sync_time = False

        self.coarse_iterations = 40000
        ...
        self.feature_lr_init = 0.0075
        self.feature_lr_final = 0.000001
        self.feature_lr_delay_mult = 0.01
        self.feature_lr_max_steps = 20_0000
        ...
        self.opacity_factor = 2 
        self.cov_factor = 2 
        self.color_factor = 2 
        self.offset_factor = 4 

        self.hash_init_lr = 0.0002
        self.hash_final_lr = 0.000002
        self.hashmap_size = 17
        self.activation = "ReLU"
        self.n_levels = 16
        self.n_features_per_level = 4
